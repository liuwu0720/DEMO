...
ProcessEngine processEngine = ProcessEngines.getDefaultProcessEngine();
	...
	public void startProcessInstance()
	{
		...
		String[] valist = { "hjx@unlcn" , "liuwu@unlcn" , "cwz@unlcn" };
		// 必须是List
		processInstVar.put( "assigneeList" , Arrays.asList( assigneeList ) );
		processInstVar.put( "valist" , Arrays.asList( valist ) );
		processInstVar.put( "signCount" , 0 );
		processInstVar.put( "inputUser" , "申请人liuwu");
