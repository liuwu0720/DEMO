...
/** 
 * @Package ParallelGateWayTest 
 * @Description:用一句话描述该文件做什么 
 * @author liuwu
 * @date 2015年10月20日 上午9:35:49 
 * @version V1.0 
 */
public class ParallelGateWayTest2
{
	...
	{
		// 流程定义的key
		String processDefinitionKey = "parallelGateWay2";
	...
	public void completeMyPersonalTask()
	{
		// 任务ID
		String taskId = "16921";
		List< Task > taskResultList = processEngine.getTaskService().createTaskQuery()
		        .taskId( taskId ).list();
		// 当前executionId
