...
<html>
  ...
  <body>
  <form action="EmployattendanceServlet/getUpdatePage" method="post">
  <div class="rightsider">

<div class="info_tabs clearfix">
 <a href="" class="hover">考勤信息</a> 
</div>
...
<dl class="notice clearfix">
  ...
  <dd>详细信息 </dd>   
			...
			<li><span>* 考勤类别：</span>${ehd.typename}</li>
			
			<li><span>* 异常原因：</span>${ehd.reason}</li>
			
			<li><span>* 异常时间：</span>${fn:substring(ehd.date1 ,0,19)  }</li>
