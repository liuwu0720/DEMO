...
public class DeptTotalCostDaoImp extends BaseDao implements IDeptTotalCostDao
{
	...
	public DeptTotalcost getByCostType( CostApply costApply , int month , Costtype costtype )
	{
		String hql = "from DeptTotalcost where  nMonth = " + month + " and iDept = " + costApply.getiDept()+" and iCosttype = "+costtype.getpId();
