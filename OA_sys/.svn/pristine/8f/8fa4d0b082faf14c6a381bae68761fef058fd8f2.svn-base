...
<html>
  ...
  <body>
  <form action="EmployovertimeServlet/getUpdatePage" method="post">
...
<dl class="notice clearfix">
  ...
  <dd>详细信息 </dd>   
			...
			<li><span>* 加班类别：</span>${ehd.employovertimeType.typename}</li>
			
			<li><span>* 加班原因：</span>${ehd.reason}</li>
			
			<li><span>* 加班内容：</span>${ehd.contents}</li>
			
			<li><span>* 加班开始时间：</span>${fn:substring(ehd.date1 ,0,19)  }</li>
			
			<li><span>* 加班结束时间：</span>${fn:substring(ehd.date2 ,0,19)  }</li>
