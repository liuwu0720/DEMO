	...
	function hoysures(id)
		{
			...
			if(confirm("出差是否确认")) 
			{
            	window.location="${pageContext.request.contextPath }/EmploytripServlet/updateEmpTripSatByID?id="+id;
...
<form action="" method="post"></form></div></div>
   ...
   <table style="margin-top: 100px;">
						<tr align="center">
							<td colspan="4" align="center"> --出差--</td>
						</tr>
						<tr>
							...
							<td width="100px;" bgcolor="#F0F0F0"><span>备注</span></td>
							<td width="100px;" bgcolor="#F0F0F0"><span>工具</span></td>
