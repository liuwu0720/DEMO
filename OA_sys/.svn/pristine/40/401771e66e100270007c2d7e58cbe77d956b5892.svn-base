...
<br><br>
   ...
   <li class="name" style="width: 10%">发布范围</li> 
     ...
     <li class="btn_turn"><span>${page }/${pages }页</span><div><a href="NotifyServlet/getAllNotify?page=${pages }"><i class="icon_next"></i></a><a href="NotifyServlet/getAllNotify?page=1"><i class="icon_pre"></i></a></div></li>
