...
<div class="usr_info_t"><h3>员工筛选：<a href="UserServlet/getUserInfo?admin=0">普通员工</a>  <a href="UserServlet/getUserInfo?admin=1">部门领导</a>  <a href="UserServlet/getUserInfo?admin=2">公司领导</a></h3>  <div class="search_box clearfix">
   ...
   <ul>
     ...
     <li class="btn_turn"><span>${page }/${pages }页</span><div><a href="UserServlet/getUserByOther?page=${pages }&id=${userno }"><i class="icon_next"></i></a><a href="UserServlet/getUserByOther?page=1&id=${userno }"><i class="icon_pre"></i></a></div></li>
