...
var temp ,temp1,phonetemp;
		$(document).ready(function(){
			...
			temp = "<tr>"+$("#travel_tr2").clone().html()+"</tr>";//差旅费
			temp1= "<tr>"+$("#traffic_tr2").clone().html()+"</tr>";//交通费
			phonetemp = "<tr>"+$("#phone_tr2").clone().html()+"</tr>";//通讯费
			//获取费用类型列表
	...
	function addTrafficBtn(obj) {
		index1++;
		var temp2 = temp1.replace(/\[0]/g, '[' + index1 + ']');
...
<body>
	<div class="rightsider">
		...
		<form action="<%=basePath%>feeController/save" method="post" onsubmit="return submitForm(this)" name="myform"
			id="myform">
			<table id="tab">
				<tr>
