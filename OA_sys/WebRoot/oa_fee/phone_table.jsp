   ...
   <table class="table">
		<tbody id="phone_tbody1">
			<tr style="font-size: 5;height: 20px;">
				...
				<td><input type="text" name="feeTels[${vstatus.index}].nDays"  value="${t.nDays }"  onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')"></td>
				<td><input type="text" name="feeTels[${vstatus.index}].nStandard"   value="${t.nStandard }" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')"></td>
				<td><input type="text" name="feeTels[${vstatus.index}].nActStandard"  value="${t.nActStandard }" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')"></td>
				<td><input type="text" name="feeTels[${vstatus.index}].nMoney"  value="${t.nMoney }" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')"></td>
