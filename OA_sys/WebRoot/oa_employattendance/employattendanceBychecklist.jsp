...
$(document).ready(function(){
	...
	if(freshenParam!=null)
	{
		...
		function delete_add(uid)
		{
		 ...
		 {
		  URL="${pageContext.request.contextPath }/EmployattendanceServlet/del?id="+uid;
		  window.location=URL;
		 }
		}
</script>
...
<div class="info_tabs clearfix">
  ...
  <div class="htsp">
	 ...
	 <span><a href="EmployattendanceServlet/getEhdByIscheck?id=a4&ischeck=0" >未审批</a> <a href="EmployattendanceServlet/getEhdByIscheck?id=a4&ischeck=1">未通过</a>  <a href="EmployattendanceServlet/getEhdByIscheck?id=a4&ischeck=2">已通过</a></span>
   ...
   <c:forEach items="${emplist}" var="ehd">
     ...
     <li class="date2" style="">
      ...
      <li class="date2" style="margin-top: 5px;width: 150px;">
     	...
     	<a style="margin-left: 10px;" href="javascript:delete_add(${ehd[0] })"> 删除</a> 
    	<a style="margin-left: 10px;" href="${pageContext.request.contextPath }/EmployattendanceServlet/getUpdatePage?id=${ehd[0] }"> 审批</a>
    	<a style="margin-left: 10px;" href="${pageContext.request.contextPath }/EmployattendanceServlet/getEhdByid?id=${ehd[0] }"> 查看</a>
