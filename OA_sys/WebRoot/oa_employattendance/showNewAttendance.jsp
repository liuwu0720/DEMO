	...
	function hoysures(id)
		{
			...
			if(confirm("考勤是否确认")) 
			{
            	window.location="${pageContext.request.contextPath }/EmployattendanceServlet/updateEmpAttentSatByID?id="+id;
...
<form action="" method="post"></form></div></div>
   ...
   <table style="margin-top: 100px;">
						<tr align="center">
							<td colspan="4" align="center"> --考勤--</td>
						</tr>
						<tr>
							...
							<td width="200px;" bgcolor="#F0F0F0"><span>异常时间</span></td>
